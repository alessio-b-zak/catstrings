...
(function(exports) {
  ...
  var csApp = (function () {
      ...
      return Halogen_Component.parentComponent(Data_Either.ordEither(Data_Ord.ordUnit)(Data_Ord.ordUnit))({
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(CatStrings.csApp)(Data_Unit.unit)(v);
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
